...
def train(args,nloader, aloader, model, batch_size, optimizer,  device):
    with torch.set_grad_enabled(True):
        ...
        scores = scores.view(batch_size * args.num_segments * 2, -1)
        scores = scores.squeeze()
        abn_scores = scores[batch_size * args.num_segments:]
